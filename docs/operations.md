...
`nexus-lang-bytecode-probe` is centered on compilers work in Julia. The technical target is: Create a Julia reference implementation for bytecode workflows, centered on simulation kernel, seeded input scenarios, and deterministic summary checks.
